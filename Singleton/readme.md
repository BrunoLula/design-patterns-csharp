Singleton – AppSettings 📌 Description
...
In this project, the Singleton is implemented using Lazy, ensuring thread safety and lazy initialization.

🧱 Project Structure 01-Singleton/ ├── AppSettings.cs ├── Program.cs └── README.md

🧠 Implementation Details Key characteristics of the AppSettings class:
...
▶️ Usage Example var settings1 = AppSettings.Instance; var settings2 = AppSettings.Instance;
